        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <!-- <span style="width: 100%;" class="text-right"> -->
			            <a class="btn btn-xs btn-default close">Edit</a>
	       <!--      </span> -->
                </div>
                <div class="panel-body">
                    <ul class="nav nav-pills nav-stacked">
                      ...
                      <a id="sendInvitationsButton" href="#" class="btn btn-lg btn-success center-block">
                          Send Invitations
                      </a>
                      <br>
...
<div id="invitationModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div id="guests-list" class="modal-content">
            ...
            <div v-if="guests.length > 0" class="modal-body" >
                ...
                <div style="max-height:400px; overflow-y:auto; overflow-x: hidden;">
                    <ol style="list-style:none;">
                        <li v-for="guest in guests" class="row" style="height: 40px;">
                            <span class="col-xs-3 vertical-center text-left">@{{guest.email}}</span>
                            <span class="col-xs-6 text-left vertical-center">
                                <span :id="'sendResults-' + guest.id"></span>
                                <pulse-loader :loading="guest.loading" :color="'grey'" :size="'5px'">
